...
export default function LabeledInput(props) {
    const { id, label, type, defaultValue, disabled = false, required = false, orientation = "vertical", placeholder, containerStyle, labelStyle, inputStyle, containerClassName, labelClassName, inputClassName, ...rest } = props;
